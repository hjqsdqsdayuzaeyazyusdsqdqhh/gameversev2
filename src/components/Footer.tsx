...
export default function Footer() {
  ...
  return (
    <motion.footer
      ...
      className={`border-t ${theme === "dark" ? "border-dark-700/50 bg-dark-850" : "border-gray-200 bg-gray-50"}`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <motion.div
          ...
          className={`border-t py-8 flex flex-col sm:flex-row items-center justify-between gap-4 ${theme === "dark" ? "border-dark-700/50" : "border-gray-200"}`}
        >
